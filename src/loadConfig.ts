...
export function loadConfig(): BotConfig {
  return {
    bot: {
      ...
      nickname: process.env.BOT_NICKNAME ?? throwEnvironmentError("BOT_NICKNAME"),
    ...
    mqtt: {
      ...
      username: process.env.MQTT_USERNAME ?? throwEnvironmentError("MQTT_USERNAME"),
      password: process.env.MQTT_PASSWORD ?? throwEnvironmentError("MQTT_PASSWORD"),
      clientId: process.env.MQTT_CLIENT_ID ?? throwEnvironmentError("MQTT_CLIENT_ID"),
      topics: {
        connected: process.env.TOPIC_CONNECTED ?? throwEnvironmentError("TOPIC_CONNECTED"),
        discovery: process.env.TOPIC_DISCOVERY ?? throwEnvironmentError("TOPIC_DISCOVERY"),
        online: process.env.TOPIC_ONLINE ?? throwEnvironmentError("TOPIC_ONLINE"),
        command: process.env.TOPIC_COMMAND ?? throwEnvironmentError("TOPIC_COMMAND"),
